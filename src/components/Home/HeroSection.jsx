  ...
  return (
    ...
    <section className=" md:flex items-center justify-evenly py-10 text-center">
      ...
      <p className=" mb-2 sm:mb-8 ">
        ...
        <h1 className="text-[#0D3451] text-[2rem] lg:text-[3rem] mb-2 sm:mb-8 font-extrabold">My VORKINSTA</h1>
      
      <p className="mb-2 sm:mb-8 font-medium sm:font-bold">
        Crafts The Future Of Work With Enduring Excellence
      </p>
      <div className="flex justify-center">
      <div className="flex text-xl mb-4 sm:mb-10">
          <input type="text"  className="border-2 bg-gray-50 py-2 sm:py-3 px-4  rounded-l-full rounded-r-none w-48 sm:w-50 lg:w-80 outline-none " placeholder='Search'></input>
          <button className="bg-black text-white px-4 lg:px-12 py-2 sm:py-3 rounded-r-full rounded-l-none">Search</button>
        </div>
        </div>
      <div className="flex justify-center items-center space-x-4  sm:mb-10 text-xl lg:text-[1.3rem] lg:font-semibold">
        <Link to='/selection'>
